...
@Component({
    moduleId: module.id,
    selector: 'currentstate-create-cmp',
    templateUrl: 'currentstate.create.component.html',
    animations: [
...
export class CurrentStateCreateComponent implements OnInit, AfterViewChecked {
