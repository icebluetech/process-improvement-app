...
import { FutureStateCreateComponent } from '../create/futurestate.create.component';

@Component({
    moduleId: module.id,
    selector: 'futurestate-detail-cmp',
    templateUrl: 'futurestate.detail.component.html',
    animations: [
...
export class FutureStateDetailComponent {
