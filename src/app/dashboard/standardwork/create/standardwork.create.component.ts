...
@Component({
    moduleId: module.id,
    selector: 'standardwork-create-cmp',
    templateUrl: 'standardwork.create.component.html',
    animations: [
...
export class StandardWorkCreateComponent implements OnInit, AfterViewChecked {
